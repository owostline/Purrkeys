      ...
      <div className="flex flex-wrap justify-center items-center">
        ...
        <div className="flex-col pt-5 lg:pt-12 w-full lg:w-1/2">
          {checklistItems.map((item, index) => (
            <div
              key={index}
              className="flex mb-12 items-start md:mx-24 lg:mx-0"
            >
              ...
              <div>
                <a
                  href="#"
                  className="mt-1 mb-2 text-xl font-semibold underline hover:text-pink-300"
                >
                  {item.title}
                </a>
                <p className="text-xs lg:text-base mr-7 text-neutral-300">
                  {item.description}
                </p>
              </div>
            </div>
