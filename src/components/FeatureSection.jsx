  ...
  return (
    <div className = "relative mt-20 border-b border-neutral-800 min-h-[600px] ">
        <div className = "text-center">
            ...
            <span className = "bg-gradient-to-r from-violet-400 to-violet-700 text-transparent bg-clip-text">Purr-fection</span> in Every Keystroke
            </h2>
        </div>
                ...
                <div key = {index} className="w-full sm:w-1/2 lg:w-1/3">
                    <div className="flex mx-7">
                        ...
                        <div className="flex flex-col">
                            ...
                            <p className="mb-11 text-neutral-300 text-xs lg:text-base">{feature.description}</p>
                        </div>
                    </div>
                </div>
            ))}
